...
export class Resume extends React.Component {
    ...
    <div>
		...
		<div className="main">
          ...
          <a className='project-link' href='https://josephafern.github.io/bombermanjs'><FaGamepad className='project-icon' /></a>
          <a className='project-link' href='https://empty-chairs.herokuapp.com'><MdFastfood className='project-icon' /></a>
          <a className='project-link' href='https://blindr-job.herokuapp.com'><ImBriefcase className='project-icon' /></a>
				</div>
			</div>
		</div>
		</div>
